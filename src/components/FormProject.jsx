    ...
    return (
        ...
        >
            ...
            <div className="w-full grid gap-y-5">
                ...
                <textarea className="w-full font-medium px-2 py-2 rounded-sm border-2 border-transparent border-b-[#45413D]/20 h-20 bg-[#E1DFDD] focus:border-b-[#45413D] focus:outline-none focus:ring-0" type="textarea" />
                </div>
                <div>
                    <label className="uppercase font-bold text-lg text-[#1C1816]/70" htmlFor="date">
                        due date
                    </label>
                    <input className="w-full font-medium px-2 rounded-sm border-2 border-transparent border-b-[#45413D]/20 h-10 bg-[#E1DFDD] focus:border-b-[#45413D] focus:outline-none focus:ring-0" type="date" />
                </div>
            </div>
        </form>
    );
